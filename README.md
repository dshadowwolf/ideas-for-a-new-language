...
# Full module system with distinct namespaces
...
# Modules are, at their root, a collection of objects
...
# Objects have a persistent lookup table that defines their functions and data members
...
# The basic syntax of the language is based on C
